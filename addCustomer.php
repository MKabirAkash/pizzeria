...
<h2 style="allign:centre;padding-left:25%">Add a Customer</h2>
<br><br>
<form action="backend.php" method="post">
  <fieldset>
  <div class="form-group">
      <label for="person">Person</label>
      <select id="disabledSelect-ok" name="selectedperson1" class="form-control">
    ...
    <div class="form-group">
      ...
      <input type="text" name="customerid" class="form-control" placeholder="Enter Unique customer Id">
    </div>
